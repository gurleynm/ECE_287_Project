          ...
          IF(ascii(7) = '0') THEN            --the PS2 code has an ASCII output
            ascii_new <= '1';                  --set flag indicating new ASCII output
				IF(ascii = x"61") THEN
					TESTa <='1';
					TESTd <='0';
				ELSIF(ascii = x"73") THEN
					TESTa <='0';
					TESTd <='0';
				ELSIF(ascii = x"77") THEN
					TESTa <='0';
					TESTd <='0';
				ELSIF(ascii = x"64") THEN
					TESTa <='0';
					TESTd <='1';
				ELSE
					TESTa <='0';
				...
				END IF;
          END IF;
          state <= ready;                    --return to ready state to await next PS2 code, code provided mostly by: https://www.digikey.com/eewiki/pages/viewpage.action?pageId=28279002
